...
trait HasTranslations
{
    ...
    public function setTranslation(string $key, string $locale, $value): self
    {
        ...
        event()->dispatch(new TranslationHasBeenSetEvent($this, $key, $locale, $oldValue, $value));
    ...
    {
        return $this->translationLocale ?: locale() ?: config('translation.locale');
    }
